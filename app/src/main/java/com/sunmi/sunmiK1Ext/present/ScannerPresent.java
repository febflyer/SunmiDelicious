 ...
 * 1.4.4版ROM将此串口扫码器做了兼容，这里用广播监听即可；原本的CodeScannerPresenter是直接串口通讯，已经不需要了。
 **/
public class ScannerPresent {
    private static final String TAG = "ScannerPresent";
    ...
    //构造
    public ScannerPresent(Context context,OnDataReceiveListener onDataReceiveListener){
...
//        private static final ScannerPresent INSTANCE = new ScannerPresent();
//    }
//
//    public static ScannerPresent getInstance(){
//        return ScannerInstance.INSTANCE;
//    }
    ...
    private class ScannerDataReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent){
            ...
            if(value.contains(ByteUtils.hexStr2Str("303030304053454E495354"))){
                Log.d(TAG,"cmd return data：" + value + "[" + ByteUtils.str2HexString(value)+ "]");
                bCmdWaitting = false;
            }
            else {
     ...
     */
    public void setMode(int mode,final int wait,int delay){
        switch (mode)
        {
